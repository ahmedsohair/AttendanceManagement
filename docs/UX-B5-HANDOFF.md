...
- Browser coverage uses a fixture auth client for null/error/rejection/stall/late results, event reorder, sign-in/sign-out, update success/failure/pending, invalidation, and unmount. It does not prove provider-specific event ordering beyond the mocked contract.
